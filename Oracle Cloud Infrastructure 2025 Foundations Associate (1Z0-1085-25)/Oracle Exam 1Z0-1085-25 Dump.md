...
- [ ] The capability to customize the number of OCUs and the amount of memory for certain VM shapes 
...
- [ ] To distribute instances across different physical hardware within an availability domain 
...
- [ ] To allow for high-vailability connectivity and building replicated systems 
